...
void main()
{
    u_xlatu0.x = (uvec2(textureSize(_CameraDepthTexture, 0)).x);
    u_xlatu0.y = (uvec2(textureSize(_CameraDepthTexture, 0)).y);
...
void main()
{
    u_xlat0 = textureGather(_MainTex, vs_TEXCOORD0.xy);
    u_xlat1.x = u_xlat0.x;
    u_xlat2 = textureGather(_MainTex, vs_TEXCOORD0.xy, 1).xzyw;
    u_xlat1.y = u_xlat2.x;
    u_xlat3 = textureGather(_MainTex, vs_TEXCOORD0.xy, 2).xywz;
    u_xlat1.z = u_xlat3.x;
    u_xlat4.x = u_xlat0.y;
    u_xlat4.y = u_xlat2.z;
    u_xlat4.z = u_xlat3.y;
    ...
    u_xlat7 = _MainTex_TexelSize.y + _MainTex_TexelSize.y;
...
void main()
{
    ...
    u_xlat16_5.xyz = u_xlat10_1.xyz + (-u_xlat16_3.xyz);
    ...
    u_xlat16_5.x = (-u_xlat10_2.w) + u_xlat16_3.x;
    u_xlat0 = u_xlat0 * u_xlat16_5.x + u_xlat10_2.w;
...
void main()
{
    ...
    u_xlat16_6 = u_xlat10_6.x * 2.0 + -1.0;
