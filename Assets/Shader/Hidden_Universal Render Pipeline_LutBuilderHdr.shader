...
;
    ...
    u_xlati4.xyz = ivec3(ivec3(lessThan(u_xlat0.xyzx, vec4(0.0, 0.0, 0.0, 0.0)).xyz) * -1);
    u_xlat0.xyz = log2(abs(u_xlat0.xyz));
    ...
    u_xlat1.x = u_xlat1.x + u_xlat16_10;
    ...
    u_xlat16_1.xyz = u_xlat16_2.xxx * u_xlat16_11.xyz + (-vec3(u_xlat16_21));
    u_xlat16_0.y = float(0.0);
    u_xlat16_18.y = float(0.0);
    u_xlat10_28 = texture2D(_CurveHueVsSat, u_xlat16_0.xy).x;
    u_xlat10_4 = texture2D(_CurveSatVsSat, u_xlat16_18.xy).x;
    u_xlat16_4 = u_xlat10_4;
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
    u_xlat16_28 = u_xlat10_28;
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
    u_xlat16_28 = u_xlat16_28 + u_xlat16_28;
    u_xlat16_28 = dot(vec2(u_xlat16_4), vec2(u_xlat16_28));
    u_xlat16_3.y = 0.0;
    u_xlat10_4 = texture2D(_CurveLumVsSat, u_xlat16_3.xy).x;
    u_xlat16_4 = u_xlat10_4;
    u_xlat16_4 = clamp(u_xlat16_4, 0.0, 1.0);
    u_xlat16_28 = u_xlat16_28 * u_xlat16_4;
    u_xlat28 = dot(_HueSatCon.yy, vec2(u_xlat16_28));
    u_xlat1.xyz = vec3(u_xlat28) * u_xlat16_1.xyz + vec3(u_xlat16_21);
    ...
    u_xlat10.x = texture2D(_CurveMaster, u_xlat0.yw).x;
    u_xlat10.y = texture2D(_CurveMaster, u_xlat0.zw).x;
    ...
    u_xlat1.x = u_xlat10_1;
    u_xlat1.x = clamp(u_xlat1.x, 0.0, 1.0);
    u_xlat10.x = texture2D(_CurveGreen, u_xlat0.yw).x;
    u_xlat10.y = texture2D(_CurveBlue, u_xlat0.zw).x;
    u_xlat1.yz = u_xlat10.xy;
    u_xlat1.yz = clamp(u_xlat1.yz, 0.0, 1.0);
    u_xlat16_2.x = max(u_xlat1.y, u_xlat1.x);
    u_xlat16_2.x = max(u_xlat1.z, u_xlat16_2.x);
...
void main()
{
    ...
    u_xlat16_0.xyz = u_xlat16_2.xyz + vec3(-0.413588405, -0.413588405, -0.413588405);
    u_xlat0.xyz = u_xlat16_0.xyz * _HueSatCon.zzz + vec3(0.413588405, 0.413588405, 0.413588405);
    ...
    u_xlat16_2.x = dot(vec3(1.45143926, -0.236510754, -0.214928567), u_xlat16_3.xyz);
    u_xlat16_2.y = dot(vec3(-0.0765537769, 1.17622972, -0.0996759236), u_xlat16_3.xyz);
    u_xlat16_2.z = dot(vec3(0.00831614807, -0.00603244966, 0.997716308), u_xlat16_3.xyz);
    u_xlat0.xyz = u_xlat16_2.xyz * _ColorFilter.xyz;
    u_xlat0.xyz = max(u_xlat0.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat0.xyz = log2(u_xlat0.xyz);
    u_xlat0.xyz = u_xlat0.xyz * vec3(0.454545468, 0.454545468, 0.454545468);
...
;
    ...
    u_xlat0.xyz = u_xlat0.xyz * _Gain.xyz + _Lift.xyz;
    u_xlati1.xyz = ivec3(ivec3(lessThan(vec4(0.0, 0.0, 0.0, 0.0), u_xlat0.xyzx).xyz) * -1);
    u_xlati5.xyz = ivec3(ivec3(lessThan(u_xlat0.xyzx, vec4(0.0, 0.0, 0.0, 0.0)).xyz) * -1);
    u_xlat0.xyz = log2(abs(u_xlat0.xyz));
    u_xlat0.xyz = u_xlat0.xyz * _Gamma.xyz;
    u_xlat0.xyz = exp2(u_xlat0.xyz);
    ...
    u_xlat16_18.y = float(0.0);
    u_xlat10_28 = texture2D(_CurveHueVsSat, u_xlat16_0.xy).x;
    u_xlat10_5 = texture2D(_CurveSatVsSat, u_xlat16_18.xy).x;
    u_xlat16_5.x = u_xlat10_5;
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
    u_xlat16_28 = u_xlat10_28;
    u_xlat16_28 = clamp(u_xlat16_28, 0.0, 1.0);
    u_xlat16_28 = u_xlat16_28 + u_xlat16_28;
    u_xlat16_28 = dot(u_xlat16_5.xx, vec2(u_xlat16_28));
    u_xlat16_3.y = 0.0;
    u_xlat10_5 = texture2D(_CurveLumVsSat, u_xlat16_3.xy).x;
    u_xlat16_5.x = u_xlat10_5;
    u_xlat16_5.x = clamp(u_xlat16_5.x, 0.0, 1.0);
    ...
    u_xlat16_2.x = (-u_xlat16_2.x) + 1.0;
    u_xlat16_2.xyz = u_xlat1.xyz / u_xlat16_2.xxx;
    u_xlat16_12.x = dot(vec3(0.695452213, 0.140678704, 0.163869068), u_xlat16_2.xyz);
    u_xlat16_12.y = dot(vec3(0.0447945632, 0.859671116, 0.0955343172), u_xlat16_2.xyz);
    u_xlat16_12.z = dot(vec3(-0.00552588282, 0.00402521016, 1.00150073), u_xlat16_2.xyz);
    u_xlat16_2.xyz = (-u_xlat16_12.yxz) + u_xlat16_12.zyx;
    u_xlat16_2.xy = u_xlat16_2.xy * u_xlat16_12.zy;
    u_xlat16_2.x = u_xlat16_2.y + u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_12.x * u_xlat16_2.z + u_xlat16_2.x;
    u_xlat16_1.x = max(u_xlat16_2.x, 0.0);
    u_xlat16_2.x = sqrt(u_xlat16_1.x);
    u_xlat16_11.x = u_xlat16_12.y + u_xlat16_12.z;
    u_xlat16_11.x = u_xlat16_12.x + u_xlat16_11.x;
    ...
    u_xlat16_20 = min(u_xlat16_12.y, u_xlat16_12.x);
    u_xlat16_20 = min(u_xlat16_12.z, u_xlat16_20);
    u_xlat16_20 = max(u_xlat16_20, 9.99999975e-05);
    u_xlat16_29 = max(u_xlat16_12.y, u_xlat16_12.x);
    u_xlat16_29 = max(u_xlat16_12.z, u_xlat16_29);
    u_xlat16_4.xy = max(vec2(u_xlat16_29), vec2(9.99999975e-05, 0.00999999978));
    u_xlat16_20 = (-u_xlat16_20) + u_xlat16_4.x;
    u_xlat16_20 = u_xlat16_20 / u_xlat16_4.y;
    ...
    u_xlatb19 = 0.159999996>=u_xlat16_2.x;
    u_xlat16_2.x = (u_xlatb10.x) ? 0.0 : u_xlat16_11.x;
    u_xlat16_2.x = (u_xlatb19) ? u_xlat1.x : u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x + 1.0;
    u_xlat0.yzw = u_xlat16_2.xxx * u_xlat16_12.xyz;
    u_xlat16_1.x = (-u_xlat16_12.x) * u_xlat16_2.x + 0.0299999993;
    u_xlat16_11.x = u_xlat16_12.y * u_xlat16_2.x + (-u_xlat0.w);
    u_xlat16_11.x = u_xlat16_11.x * 1.73205078;
    u_xlat16_29 = u_xlat0.y * 2.0 + (-u_xlat0.z);
    u_xlat16_2.x = (-u_xlat16_12.z) * u_xlat16_2.x + u_xlat16_29;
    ...
    u_xlat16_10.x = u_xlat16_2.x * 0.0148148146;
    u_xlat16_10.x = -abs(u_xlat16_10.x) + 1.0;
    ...
    u_xlat16_2.x = dot(vec3(1.45143926, -0.236510754, -0.214928567), u_xlat0.xzw);
    u_xlat16_2.y = dot(vec3(-0.0765537769, 1.17622972, -0.0996759236), u_xlat0.xzw);
    u_xlat16_2.z = dot(vec3(0.00831614807, -0.00603244966, 0.997716308), u_xlat0.xzw);
    u_xlat16_2.xyz = max(u_xlat16_2.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_1.x = dot(u_xlat16_2.xyz, vec3(0.272228986, 0.674081981, 0.0536894985));
    u_xlat16_10.xyz = (-u_xlat16_1.xxx) + u_xlat16_2.xyz;
    u_xlat16_1.xyz = u_xlat16_10.xyz * vec3(0.959999979, 0.959999979, 0.959999979) + u_xlat16_1.xxx;
    u_xlat16_5.xyz = u_xlat16_1.xyz * vec3(2.78508496, 2.78508496, 2.78508496) + vec3(0.107772, 0.107772, 0.107772);
    u_xlat16_5.xyz = u_xlat16_1.xyz * u_xlat16_5.xyz;
    u_xlat16_6.xyz = u_xlat16_1.xyz * vec3(2.93604493, 2.93604493, 2.93604493) + vec3(0.887121975, 0.887121975, 0.887121975);
    u_xlat16_1.xyz = u_xlat16_1.xyz * u_xlat16_6.xyz + vec3(0.806888998, 0.806888998, 0.806888998);
    u_xlat16_1.xyz = u_xlat16_5.xyz / u_xlat16_1.xyz;
    u_xlat16_2.x = dot(vec3(0.662454188, 0.134004205, 0.156187683), u_xlat16_1.xyz);
    u_xlat16_2.y = dot(vec3(0.272228718, 0.674081743, 0.0536895171), u_xlat16_1.xyz);
    u_xlat16_2.z = dot(vec3(-0.00557464967, 0.0040607336, 1.01033914), u_xlat16_1.xyz);
    u_xlat16_20 = dot(u_xlat16_2.xyz, vec3(1.0, 1.0, 1.0));
    u_xlat16_20 = max(u_xlat16_20, 9.99999975e-05);
    u_xlat16_3.xy = u_xlat16_2.xy / vec2(u_xlat16_20);
    u_xlat16_2.x = max(u_xlat16_2.y, 0.0);
    u_xlat16_2.x = min(u_xlat16_2.x, 65504.0);
    u_xlat16_2.x = log2(u_xlat16_2.x);
    u_xlat16_2.x = u_xlat16_2.x * 0.981100023;
    u_xlat16_2.y = exp2(u_xlat16_2.x);
    u_xlat16_29 = (-u_xlat16_3.x) + 1.0;
    u_xlat16_3.z = (-u_xlat16_3.y) + u_xlat16_29;
    u_xlat16_29 = max(u_xlat16_3.y, 9.99999975e-05);
    u_xlat16_29 = u_xlat16_2.y / u_xlat16_29;
    u_xlat16_2.xz = vec2(u_xlat16_29) * u_xlat16_3.xz;
    u_xlat16_3.x = dot(vec3(1.6410234, -0.324803293, -0.236424699), u_xlat16_2.xyz);
    u_xlat16_3.y = dot(vec3(-0.663662851, 1.61533165, 0.0167563483), u_xlat16_2.xyz);
    u_xlat16_3.z = dot(vec3(0.0117218941, -0.00828444213, 0.988394856), u_xlat16_2.xyz);
    u_xlat16_1.x = dot(u_xlat16_3.xyz, vec3(0.272228986, 0.674081981, 0.0536894985));
    u_xlat16_10.xyz = (-u_xlat16_1.xxx) + u_xlat16_3.xyz;
    u_xlat16_1.xyz = u_xlat16_10.xyz * vec3(0.930000007, 0.930000007, 0.930000007) + u_xlat16_1.xxx;
    u_xlat5.x = dot(vec3(0.662454188, 0.134004205, 0.156187683), u_xlat16_1.xyz);
    u_xlat5.y = dot(vec3(0.272228718, 0.674081743, 0.0536895171), u_xlat16_1.xyz);
    u_xlat5.z = dot(vec3(-0.00557464967, 0.0040607336, 1.01033914), u_xlat16_1.xyz);
...
;
    ...
    u_xlat16_11.x = dot(vec3(0.695452213, 0.140678704, 0.163869068), u_xlat16_1.xyz);
    u_xlat16_11.y = dot(vec3(0.0447945632, 0.859671116, 0.0955343172), u_xlat16_1.xyz);
    u_xlat16_11.z = dot(vec3(-0.00552588282, 0.00402521016, 1.00150073), u_xlat16_1.xyz);
    ...
    u_xlat16_2.x = u_xlat16_11.x * u_xlat16_3.z + u_xlat16_2.x;
    u_xlat16_1.x = max(u_xlat16_2.x, 0.0);
    u_xlat16_2.x = sqrt(u_xlat16_1.x);
    u_xlat16_3.x = u_xlat16_11.y + u_xlat16_11.z;
    u_xlat16_3.x = u_xlat16_11.x + u_xlat16_3.x;
    u_xlat16_2.x = u_xlat16_2.x * 1.75 + u_xlat16_3.x;
    u_xlat16_3.x = u_xlat16_2.x * 0.333333343;
    ...
    u_xlat16_12.xyz = max(u_xlat16_12.xyy, vec3(9.99999975e-05, 9.99999975e-05, 0.00999999978));
    u_xlat16_12.x = (-u_xlat16_12.x) + u_xlat16_12.y;
    u_xlat16_12.x = u_xlat16_12.x / u_xlat16_12.z;
    u_xlat1.x = u_xlat16_12.x + -0.400000006;
    u_xlat16_21 = u_xlat1.x * 2.5;
#ifdef UNITY_ADRENO_ES3
    u_xlatb1.x = !!(u_xlat1.x>=0.0);
#else
    u_xlatb1.x = u_xlat1.x>=0.0;
    ...
    u_xlat1.x = u_xlat1.x * u_xlat16_21 + 1.0;
    u_xlat1.x = u_xlat1.x * 0.0250000004;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat1.x;
#ifdef UNITY_ADRENO_ES3
    u_xlatb10.x = !!(u_xlat16_2.x>=0.479999989);
#else
    u_xlatb10.x = u_xlat16_2.x>=0.479999989;
    ...
    u_xlatb19.x = 0.159999996>=u_xlat16_2.x;
#endif
    u_xlat16_2.x = (u_xlatb10.x) ? 0.0 : u_xlat16_3.x;
    u_xlat16_2.x = (u_xlatb19.x) ? u_xlat1.x : u_xlat16_2.x;
    u_xlat16_2.x = u_xlat16_2.x + 1.0;
    u_xlat0.yzw = u_xlat16_2.xxx * u_xlat16_11.xyz;
    u_xlat16_1.x = (-u_xlat16_11.x) * u_xlat16_2.x + 0.0299999993;
    u_xlat16_11.x = u_xlat16_11.y * u_xlat16_2.x + (-u_xlat0.w);
    u_xlat16_11.x = u_xlat16_11.x * 1.73205078;
    u_xlat16_20 = u_xlat0.y * 2.0 + (-u_xlat0.z);
    u_xlat16_2.x = (-u_xlat16_11.z) * u_xlat16_2.x + u_xlat16_20;
    ...
    u_xlat16_10.x = u_xlat16_29 * 0.0208350997 + -0.0851330012;
    u_xlat16_10.x = u_xlat16_29 * u_xlat16_10.x + 0.180141002;
    u_xlat16_10.x = u_xlat16_29 * u_xlat16_10.x + -0.330299497;
    u_xlat16_10.x = u_xlat16_29 * u_xlat16_10.x + 0.999866009;
...
#endif
    u_xlat19 = u_xlatb28 ? u_xlat19 : float(0.0);
    u_xlat10.x = u_xlat16_20 * u_xlat16_10.x + u_xlat19;
    u_xlat16_2.z = min(u_xlat16_2.x, u_xlat16_11.x);
    u_xlat16_11.x = max(u_xlat16_2.x, u_xlat16_11.x);
    u_xlatb19.xy = lessThan(u_xlat16_2.xzxz, (-u_xlat16_2.xzxz)).xy;
    ...
    u_xlatb10.x = 180.0<u_xlat16_2.x;
#endif
    u_xlat16_11.xy = u_xlat16_2.xx + vec2(360.0, -360.0);
...
;
    ...
    u_xlat16_2.xyz = u_xlat1.xyz * u_xlat16_2.xxx;
    u_xlat16_1.xyz = max(u_xlat16_2.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat16_2.xyz = u_xlat16_1.xyz * vec3(0.262677222, 0.262677222, 0.262677222) + vec3(0.0695999935, 0.0695999935, 0.0695999935);
    u_xlat16_3.xyz = u_xlat16_1.xyz * vec3(1.31338608, 1.31338608, 1.31338608);
    u_xlat16_8.xyz = u_xlat16_1.xyz * vec3(0.262677222, 0.262677222, 0.262677222) + vec3(0.289999992, 0.289999992, 0.289999992);
    u_xlat16_8.xyz = u_xlat16_3.xyz * u_xlat16_8.xyz + vec3(0.0816000104, 0.0816000104, 0.0816000104);
    u_xlat16_2.xyz = u_xlat16_3.xyz * u_xlat16_2.xyz + vec3(0.00543999998, 0.00543999998, 0.00543999998);
