...
void main()
{
    ...
    if(u_xlatb0.y){
        ...
        u_xlat16_12 = u_xlat10_12 * -2.00787401 + 3.25;
        u_xlat0.z = (-_Metrics.y) * u_xlat16_12 + u_xlat3.y;
...
void main()
{
    ...
    if(u_xlatb6){
        ...
        if(u_xlatb18){
            ...
            u_xlat1.x = _Metrics.x * u_xlat16_18 + u_xlat2.y;
            u_xlat1.y = vs_TEXCOORD3.y;
            ...
            u_xlat16_18 = u_xlat10_18 * -2.00787401 + 3.25;
            u_xlat1.z = (-_Metrics.x) * u_xlat16_18 + u_xlat4.y;
...
;
    ...
    if(u_xlatb0){
        ...
        u_xlat0.z = (-_Metrics.y) * u_xlat16_13 + u_xlat3.y;
